...
public class GreyMatterDataMakeDirectoryRequest extends HttpEntityEnclosingRequestBase {
    private final static String METHOD_NAME = "POST";

    /**
     * @throws IllegalArgumentException if the uri is invalid.
     */
    public GreyMatterDataMakeDirectoryRequest(GreyMatterClientConfig config, final ArrayList<Metadata> metadata) {
        super();
